...
def main(planet_id: int, building_type: int) -> tuple:
    ...
    building_mapping = {
        PlanetBuildings.METAL_MINE.value:      ("bld_metal_mine",      [0, 1, 1],   48000),
        PlanetBuildings.CRYSTAL_MINE.value:    ("bld_crystal_mine",    [1, 0, 1],   48000),
        PlanetBuildings.GAS_MINE.value:        ("bld_gas_mine",        [1, 1, 0],   48000),
        PlanetBuildings.METAL_STORAGE.value:   ("bld_metal_storage",   [0, 1, 1],   24000),
        PlanetBuildings.CRYSTAL_STORAGE.value: ("bld_crystal_storage", [1, 0, 1],   24000),
        PlanetBuildings.GAS_STORAGE.value:     ("bld_gas_storage",     [1, 1, 0],   24000),
        PlanetBuildings.FACTORY.value:         ("bld_factory",         [1, 1, 0.5], 72000),
        PlanetBuildings.SHIPYARD.value:        ("bld_shipyard",        [1, 0.5, 1], 48000),
        PlanetBuildings.LABORATORY.value:      ("bld_laboratory",      [0.5, 1, 1], 48000),
        PlanetBuildings.TERRAFORMER.value:     ("bld_terraformer",     [1, 1, 1],   72000),
    }
